...
6. Clinical drug supply optimization for just-in-time supply models
  ...
  + Christi Kleoudis: How does one resupply JIT and protect the blind - at the drug depot level and site level?

7. Strategic data collection and analysis planning for alignment with Target Product Profile

+ Christi Kleoudis: How does one increase the probability of technical success based on data collection and analysis planning?
